  ...
  return (
    <DropdownMenu open={open} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        {unread > 0 && (
          <span
            className="pointer-events-none absolute -top-0.5 -right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-destructive px-1 text-[10px] font-bold text-destructive-foreground"
            aria-hidden="true"
          >
            {unread > 99 ? "99+" : unread}
          </span>
